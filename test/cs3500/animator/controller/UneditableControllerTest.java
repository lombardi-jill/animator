...
/**
 * Tests for the uneditable controller that does not interact with the model.
 */
public class UneditableControllerTest {
  ...
  public void testTextView() {
    ...
    IAnimationController controller = new UneditableControllerImpl(view);
  ...
  public void testNullView() {
    new UneditableControllerImpl(null);
  }
}